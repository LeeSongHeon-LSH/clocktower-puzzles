    ...
    <article className="space-y-10 text-sm leading-relaxed">
      ...
      <section className="space-y-4">
        ...
        <ol className="space-y-3">
          {[
            ...
            {
              t: "‘유일해 검증’을 누릅니다",
              d: "브라우저가 그 자리에서 솔버를 돌립니다. 보통 눈 깜짝할 새(15밀리초 이내)에 끝납니다.",
            },
            {
              t: "링크를 받아 공유합니다",
      ...
      <section className="space-y-4">
        ...
        <dl className="space-y-3">
          {[
            {
              t: "역할 풀을 좁게 잡으세요",
              d: "가능성이 줄수록 추리가 선명해집니다. 넣을까 말까 싶은 역할은 빼는 편이 거의 항상 낫습니다.",
            },
            {
              t: "‘해가 여럿’이면 단서가 아니라 제약이 부족한 것입니다",
              d: "정보를 더 넣기 전에 역할 풀부터 좁혀 보세요. 대개 그쪽이 문제를 덜 지저분하게 만듭니다.",
            },
            {
      ...
      <section className="space-y-4">
        ...
        <ol className="space-y-3">
          {[
            {
              t: "먼저 경로 A로 검증을 통과시키세요",
              d: "유일해가 아닌 문제는 어차피 수록되지 않습니다. 링크가 나왔다면 절반은 끝난 겁니다.",
            },
            {
              t: "저장소에 문제 파일을 추가해 Pull Request를 엽니다",
              d: "src/data/puzzles/ 안의 기존 파일 하나를 복사해 고치는 게 가장 빠릅니다. 힌트(최대 2개)와 단계별 해설을 함께 써 주세요 — 정식 수록 문제에는 해설이 필요합니다.",
            },
            {
              t: "자동 검증이 돌아갑니다",
        ...
        <p className="max-w-prose text-faded">
          ...
          입니다. GitHub이 익숙하지 않다면 경로 A의 링크를 그대로 보내 주셔도 됩니다.
        </p>
      </section>
