    ...
    <article className="space-y-10 text-sm leading-relaxed">
      ...
      <section className="space-y-3">
        ...
        <p className="max-w-prose text-faded">
          ...
          <strong className="text-parchment">지금 이 순간의 악마가 누구인지</strong>, 그 악마가 어떤
          악마인지(대본에 악마가 둘 이상일 때), 하수인이 누구인지를 차례로 답합니다. 정답은 입력한
          그리모어에서 자동으로 나오므로 따로 적을 것도 없습니다. (수록 문제 중에는 그 뒤에 주정뱅이
          같은 트릭을 더 묻는 것도 있습니다. 찍어서 맞힌 사람을 걸러 내는 보너스 단계일 뿐, 틀이 다른
          것은 아닙니다.)
        </p>
      </section>
