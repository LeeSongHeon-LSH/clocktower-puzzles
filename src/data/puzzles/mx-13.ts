...
// 보통: 좀버얼 — 대본에 악마가 셋이다. 죽음의 리듬이 그중 하나를 지목한다.
// 좀버얼은 직전 낮에 처형으로 죽은 사람이 있으면 그 밤 아예 깨어나지 않는다.
export default definePuzzle({
  ...
  intro:
    ...
    "이 대본의 악마는 임프·보르톡스·좀버얼 셋 중 하나다. 그리고 군인도 수도사도 구마사제도 독살범도 없다.",
  claims: [
  ...
  walkthrough: [
    ...
    "③ 남은 것은 좀버얼이다. 좀버얼은 직전 낮에 처형으로 죽은 사람이 있으면 그 밤 아예 깨어나지 않는다 — 낮1에 A를 처형했으니 밤2는 조용했고, 낮2에 처형이 없었으니 밤3에 다시 손을 뻗었다. 죽음의 리듬 자체가 악마의 이름이었다.",
    ...
    "⑧ 재구성: 좀버얼 C는 수사관을 사칭하며 A와 E에게 혐의를 씌웠다. 마을은 그 말에 넘어가 진짜 요리사 A를 처형했고 — 그 처형이 공교롭게도 악마를 하룻밤 재웠다.",
  ],
