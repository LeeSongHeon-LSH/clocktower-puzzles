...
export default definePuzzle({
  ...
  walkthrough: [
    ...
    "② 밤3에 두 사람이 한꺼번에 죽었다. 이 대본에는 암살자도 대부도 할머니도 땜장이도 소문꾼도 달의 자손도 없으니 두 죽음 모두 악마의 것이다. 한 밤에 둘을 죽일 수 있는 악마는 매밤 두 명을 고르는 **샤발로스**뿐이다 — 포가 셋을 고르는 밤은 '아무도 고르지 않은' 밤 다음에만 열리는데 밤2에는 D가 죽었다. 임프·좀버얼·보르톡스·푸카·팡 구·비고르모르티스는 한 밤에 하나다.",
    ...
    "⑤ 점쟁이 H를 보자. 밤2 'A와 G 중 악마 없음', 밤3 'B와 F 중 악마 없음'. H가 정직하다면 악마는 A·B·F·G가 아니고, C는 은둔자이므로 남는 후보는 D·E·H다. D는 밤2에 죽었는데 샤발로스는 제 손으로 자신을 삼키지 않는다. **악마는 E 아니면 H다.**",
