...
export default definePuzzle({
  ...
  intro:
    ...
    "이 중 두 명 — 임프와 부정한 여인 — 은 거짓말을 하고 있다.",
  claims: [
  ...
  questions: [
    ...
    { id: "scarletwoman", text: "부정한 여인은 누구인가?", answerSeats: [3] },
  ],
  hints: [
    "E의 초공감자 주장이 참이라면 D와 A는 둘 다 선해야 한다. 그럼 D의 세탁부 주장과 B의 수사관 주장을 동시에 믿을 수 있는지 따져보라.",
    "B의 수사관 정보(C 또는 D가 부정한 여인)가 참이라고 가정하고, C가 악역인 경우와 D가 악역인 경우를 각각 끝까지 밀어보라.",
  ],
  walkthrough: [
    ...
    "③ 악역은 붙어 있으므로(①) 나머지 한 명은 D 또는 A다. A가 악역이라면 B의 수사관 정보(C 또는 D가 부정한 여인)가 거짓이 되는데, B·C·D가 모두 선한 세계에서 이는 불가능하다. 따라서 악역 쌍은 D와 E다.",
    "④ B의 수사관 정보에 의해 D가 부정한 여인이다. 그러므로 데몬(임프)은 E다. C의 점쟁이 '있음' 정보(D 또는 E에 데몬)와도 정확히 맞아떨어진다.",
  ],
