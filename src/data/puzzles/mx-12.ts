...
export default definePuzzle({
  ...
  intro:
    ...
    "이 대본의 악마는 팡 구·임프·좀버얼·샤발로스 넷 중 하나다. " +
  ...
  walkthrough: [
    ...
    "⑥ 그리고 외지인의 존재 자체가 악마의 종류를 못박는다. 7인 판은 원래 외지인이 0명인데 D가 은둔자를 밝혔고, 이 대본에서 외지인을 한 명 늘리는 것은 팡 구뿐이다 — 좀버얼도 샤발로스도 아니다. 팡 구의 점프는 능력으로 죽인 첫 외지인에게 일어나며, 그 외지인 자리는 D가 채운다 — 밤2에 팡 구 C가 D를 노렸고, D가 새 팡 구가 되면서 C가 대신 죽었다. 지금 이 순간의 악마는 D다.",
