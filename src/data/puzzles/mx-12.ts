...
export default definePuzzle({
  ...
  intro:
    ...
    "이 대본의 악마는 팡 구다 — 능력으로 죽인 첫 외지인이 대신 팡 구가 되고, 원래의 팡 구가 죽는다. " +
  ...
  walkthrough: [
    ...
    "⑤ 악마가 죽었는데 게임이 이어지는 길은 둘뿐이다 — 탕녀의 승계, 또는 팡 구의 점프. 탕녀 E가 이어받았다면 E의 토큰은 악마의 것으로 바뀌었을 텐데, 장의사 G는 처형된 E에게서 '탕녀'를 보았다. 승계는 없었다. 남은 것은 점프뿐이다.",
    "⑥ 팡 구의 점프는 능력으로 죽인 첫 외지인에게 일어난다. 이 판의 외지인 한 자리는 스스로 은둔자를 밝힌 D가 채운다 — 밤2에 팡 구 C가 D를 노렸고, D가 새 팡 구가 되면서 C가 대신 죽었다. 지금 이 순간의 악마는 D다.",
