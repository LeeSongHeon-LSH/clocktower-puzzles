...
// 어려움 4: 탕녀 승계 — 임프는 확실히 처형됐다. 장의사도 확인했다.
...
export default definePuzzle({
  ...
  hints: [
    "밤3에 A가 죽었다. A가 악역이라면 — 특히 A가 임프라면 — 그 죽음을 설명할 방법이 있는가? 승계 규칙(탕녀, 스타 패스)까지 따져보라.",
  ...
  walkthrough: [
    ...
    "② 정직한 장의사 A의 증언에 의해, 첫날 처형된 B의 토큰은 임프였다. 진짜 임프가 처형됐는데 게임이 계속됐다 — 튜즈베리에서 그 방법은 하나뿐이다: 처형 시점에 5인 이상 생존(7인 전원 생존)이었고 탕녀가 임프를 승계했다.",
    "③ B가 임프였으므로 세탁부 쌍 {B, F}의 악역 몫은 B가 채웠다. F는 진짜 세탁부다.",
    "④ 남은 것은 탕녀 한 명. 요리사 G가 처형됐지만 그의 밤1 정보는 유효하다 — G가 악역이라면 악역이 셋(B, G, +여인)이 되니 G도 선·정직이다. 요리사의 '인접 악역 쌍 1'은 밤1 기준으로 임프 B의 양옆(A 또는 C) 중 하나가 탕녀라는 뜻이다. A는 ①에서 선함이 증명됐다 — 탕녀는 C다.",
    ...
    "⑥ 결론: 처형된 최초의 임프는 B, 그리고 지금 이 순간의 악마는 임프를 승계한 탕녀 C다. 마을은 악마를 죽였다 — 그리고 악마는 여전히 살아 있다.",
  ],
