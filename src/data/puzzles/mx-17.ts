...
export default definePuzzle({
  ...
  intro:
    ...
    "이 대본의 악마는 임프·포·샤발로스 셋 중 하나이고, 암살자도 대부도 할머니도 없다.",
  claims: [
  ...
  walkthrough: [
    "① 밤3에 세 사람이 한꺼번에 죽었다. 이 대본에는 암살자도 대부도 할머니도 없으므로 추가 사망을 만들 수단이 없다 — 셋 모두 악마의 손이다. 임프는 하룻밤에 하나, 샤발로스는 최대 둘을 고른다. 셋을 고를 수 있는 것은 포뿐이다.",
