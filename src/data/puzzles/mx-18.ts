...
export default definePuzzle({
  ...
  walkthrough: [
    ...
    "⑦ 악마의 종류도 기록이 정한다. 좀버얼이라면 낮1에 처형 사망이 있었으므로 밤2에 아예 깨어나지 못해 H가 죽을 수 없다. 보르톡스라면 처형 없는 낮2를 넘기는 순간 게임이 끝났어야 한다. 팡 구는 외지인을 하나 늘리고 비고르모르티스는 하나 줄이는데, 이 판의 외지인은 B 한 명으로 이미 딱 맞는다. 남는 것은 임프뿐이다.",
