...
// (임프·포·샤발로스·좀버얼은 밤2부터, 하수인 후보 넷은 아예 깨지 않는다.)
export default definePuzzle({
  ...
  walkthrough: [
    ...
    "④ 객실 청소부 A는 밤1에 **B와 D 중 정확히 한 명이 깨어났다**고 말한다. 시장은 밤에 깨어나지 않고 주정뱅이도 없으니, 깨어난 쪽은 자기 역할을 감춘 악역이다. 그런데 이 대본에서 **밤1에 깨어나는 악역은 푸카뿐이다** — 임프·포·샤발로스·좀버얼·보르톡스는 모두 밤2부터 움직이고, 탕녀·남작·악의 쌍둥이는 아예 깨지 않는다. 그러니 A가 정직하다면 악마는 B 아니면 D이고, 그 악마는 푸카다.",
