...
// 쉬움: 샤바로스 — 한 밤에 두 사람이 한꺼번에 죽었다. 이 대본에서 그럴 수 있는 것은 하나뿐이다.
export default definePuzzle({
  ...
  intro:
    ...
    "대본의 악마는 임프·좀버얼·샤바로스·포·보르톡스 다섯 중 하나다.",
  claims: [
  ...
  walkthrough: [
    ...
    "⑥ 어떤 악마인가. 밤2에 A와 C가 한꺼번에 죽었다. 대본에 암살자도 대부도 할머니도 땜장이도 없으니 그 두 죽음은 둘 다 악마의 것이다. 임프도 좀버얼도 한 밤에 한 명뿐이고, 포가 세 명을 고르는 밤은 스스로 아무도 고르지 않은 밤 다음에만 열리는데 첫 밤에는 악마가 애초에 움직이지 않는다. 보르톡스라면 지나간 낮마다 처형이 있어야 하는데 낮1에는 처형이 없었다. 매밤 두 사람을 고르는 샤바로스만 남는다.",
    ...
    "⑧ 재구성: 샤바로스 D와 탕녀 E는 나란히 앉아 각자 시계공과 요리사를 사칭했고, 밤2에 D가 A와 C를 한꺼번에 삼켰다. 죽은 수사관 A가 남긴 한 줄이 결국 옆자리의 가짜 요리사를 가리켰다.",
  ],
