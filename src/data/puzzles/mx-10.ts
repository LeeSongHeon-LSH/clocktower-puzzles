...
export default definePuzzle({
  ...
  walkthrough: [
    ...
    "⑧ 악마의 종류도 죽음의 기록이 정한다. 좀버얼이라면 낮1에 처형 사망이 있었으니 밤2에 깨어나지 못해 H가 죽을 수 없다. 보르톡스라면 처형 없는 낮2를 넘기는 순간 게임이 끝났어야 한다. 비고르모르티스라면 외지인이 한 명 줄어 스스로 건달을 밝힌 C의 자리가 사라진다. 남는 것은 임프뿐이다.",
